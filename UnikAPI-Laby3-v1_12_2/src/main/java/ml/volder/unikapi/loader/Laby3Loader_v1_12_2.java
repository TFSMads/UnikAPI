...
import ml.volder.unikapi.api.ApiReferenceStorageLaby3_v1_12_2;
import ml.volder.unikapi.logger.Laby3Logger_v1_12_2;
...
public class Laby3Loader_v1_12_2 extends LabyModAddon {
    @Override
    public void onEnable() {
        UnikAPI.LOGGER = new Laby3Logger_v1_12_2("UnikAPI");
        UnikAPI.initAPI("labymod3", null, Minecraft.getMinecraft().getVersion().replace("LabyMod-3-", ""));
        UnikAPI.registerReferenceStorage(ApiReferenceStorageLaby3_v1_12_2.getInstance());
    ...
    protected void fillSettings(List<SettingsElement> list) {
        ...
        list.add(new SettingsElement("UnikAPI", null) {
            ...
            public void draw(int x, int y, int maxX, int maxY, int mouseX, int mouseY) {
                AddonMain.callOpenSettings(Laby3Loader_v1_12_2.this);
            }
