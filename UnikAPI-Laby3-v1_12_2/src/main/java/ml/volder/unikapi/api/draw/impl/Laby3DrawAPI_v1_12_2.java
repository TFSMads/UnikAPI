...
public class Laby3DrawAPI_v1_12_2 implements DrawAPI {

    private static Laby3DrawAPI_v1_12_2 instance;

    public static Laby3DrawAPI_v1_12_2 getAPI() {
        if(instance == null)
            instance = new Laby3DrawAPI_v1_12_2();
        return instance;
    }
    ...
    public void renderItemIntoGUI(Material material, int itemDamage, double x, double y, double scale) {
        Item item = Item.REGISTRY.getObject(new net.minecraft.util.ResourceLocation(material.getNamespace(), material.getPath(MinecraftAPI.getAPI().isLegacy())));
