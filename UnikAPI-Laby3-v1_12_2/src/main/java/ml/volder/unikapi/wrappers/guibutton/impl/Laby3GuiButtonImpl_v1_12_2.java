...
public class Laby3GuiButtonImpl_v1_12_2 extends GuiButton implements IGuiButtonImpl {

    //region Implementaion
    private WrappedGuiButton guiButton;

    public Laby3GuiButtonImpl_v1_12_2(int buttonId, int x, int y, String buttonText, WrappedGuiButton button)
    {
        this(buttonId, x, y, 200, 20, buttonText, button);
    }

    public Laby3GuiButtonImpl_v1_12_2(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, WrappedGuiButton button)
    {
